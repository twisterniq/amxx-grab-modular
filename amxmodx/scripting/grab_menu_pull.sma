...
public stock const PluginName[] = "Grab Menu: Pull"
...
new const ITEM_NAME[] = "GRAB_MENU_PULL"

// Unique identificator of this item
new const ITEM_KEY[] = "pull"
...
public plugin_init()
{
    ...
    register_dictionary("grab_menu_pull.txt")
...
func_CreateCVars()
{
    g_pCVars[CVAR_TEAM] = create_cvar(
        .name = "grab_menu_pull_grabber_team",
        .string = "abc",
        .flags = FCVAR_NONE,
    ...
    g_pCVars[CVAR_TARGET_TEAM] = create_cvar(
        .name = "grab_menu_pull_grabbed_team",
        .string = "ab",
        .flags = FCVAR_NONE,
    ...
    bind_pcvar_float(
        create_cvar(
            .name = "grab_menu_pull_units",
            .string = "15.0",
            .flags = FCVAR_NONE,
            .description = fmt("%L", LANG_SERVER, "GRAB_MENU_PULL_CVAR_UNITS"),
            .has_min = true,
            .min_val = 0.1
        ), g_flCVarUnits
    )

    AutoExecConfig(true, "grab_menu_pull", "grab_modular")
}
